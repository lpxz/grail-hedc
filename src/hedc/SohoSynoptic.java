...
public class SohoSynoptic extends MetaSearchResult {
    ...
    private static final String ADDRESS_ ="http://sohowww.nascom.nasa.gov/data/synoptic/gif/"; //;"http://sohowww.nascom.nasa.gov/data/synoptic/gif/";
	...
	Regexp reg = Regexp.compile("<a href=\\\"([a-zA-Z0-9_\\.]*)\\\">");//<A HREF=\\\"([a-zA-Z0-9_\\.]*)\\\">
	Result result;
	int pos = 0;
